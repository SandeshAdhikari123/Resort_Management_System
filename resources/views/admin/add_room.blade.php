...
<div class="overview">
    ...
    <form action="{{url('store_room')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea id="room_description" name="room_description" class="form-control" placeholder="Enter room description" required></textarea>
        </div>
        ...
        <div class="form-group">
        <label for="room_capacity">Room Type </label>
        ...
        <div class="form-group">
            ...
            <input type="number" id="room_price" name="room_price" class="form-control" placeholder="Enter room price" required>
        </div>
        <!-- Image Upload -->
        <div class="form-group">
            <label for="room_image">Room Image</label>
            <input type="file" id="room_image" name="room_image" class="form-control" accept="image/*" required>
        </div>
